        ...
        <div class="cart-content">
          ...
          <div class="table-responsive mb-4">
              ...
              <table class="table text-nowrap">
                ...
                <tbody class="border-0 products-in-cart">
              ...
              <div class="card-body">
                ...
                <ul class="list-unstyled mb-0">
                  <li class="d-flex align-items-center justify-content-between">
                    <strong class="text-uppercase small font-weight-bold">Subtotal: $<span class="text-muted small cart-subtotal">0</span></strong>
                  </li>
                  <li class="d-flex align-items-center justify-content-between">
                    <strong class="text-uppercase small font-weight-bold">Tax: $<span class="text-muted small cart-tax">0</span></strong>
                  </li>
                  <li class="border-bottom my-2"></li>
                  <li class="d-flex align-items-center justify-content-between mb-4">
                    <strong class="text-uppercase small font-weight-bold">Total: $<span class="cart-total">0</span></strong>
                  </li>
                  <li>
                    <form action="#">
